...
public class FilesService {
  ...
  public String openFile(
    ...
    String wopiHost = networkingConfig
        ...
        .orElse(Constants.Config.Wopi.DEFAULT_HOST);
    String wopiPort = networkingConfig
        .get(DocsConnectorServiceConfig.NetworkingConfig.WOPI_PORT)
        .orElse(String.valueOf(Constants.Config.Wopi.DEFAULT_PORT));
  ...
  private long getMaxSizeLimitForFileType(GenericFileType fileType) {
    ...
    return applicationConfig
        .get(configKey)
        .map(Long::parseLong)
        .orElseGet(() -> Constants.Config.DEFAULT_MAX_FILE_SIZE_IN_MB_PER_TYPE.get(fileType));
  }
}
