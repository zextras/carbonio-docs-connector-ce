...
/**
 * Thrown when a file operation is rejected because the account is over quota. Maps to HTTP 422
 * (Unprocessable Entity) for template upload and HTTP 413 (Payload Too Large) for WOPI save
 * operations.
 */
