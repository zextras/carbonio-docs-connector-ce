...
public class NodeAttributes {
  ...
  public static String getNodeGraphQLRequest(String nodeId, Optional<Integer> optVersion) {
  ...
  public static NodeAttributes mapFromJSON(String graphQLResponse) throws JsonProcessingException {
    ...
    String response = mapper.readTree(graphQLResponse).get("data").get("getNode").toString();
