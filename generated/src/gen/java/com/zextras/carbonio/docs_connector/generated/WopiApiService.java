...
public interface WopiApiService {
      ...
      throws NotFoundException;
      Response saveBlob(UUID nodeId,String accessToken,Boolean xCOOLWOPIIsAutosave,Boolean xCOOLWOPIIsExitSave,Long contentLength,InputStream body,SecurityContext securityContext)
      throws NotFoundException;
}
